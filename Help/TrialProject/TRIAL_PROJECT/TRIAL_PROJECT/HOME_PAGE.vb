...
Public Class HOME_PAGE
    ...
    Private Sub CodeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CodeToolStripMenuItem.Click
       EMPLOYEE_ALL_CODE_FORM.Show()
    End Sub

    Private Sub WithoutCodeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WithoutCodeToolStripMenuItem.Click
        EMPLOYEE_ALL_WITHCODE_FORM.Show()
    End Sub
